...
Saving graphs to file is carried out witht he command `ggsave()` 

The only required parameter is a filename for example: `ggsave("LIBMFacetsWithTrend.jpg")`

BY DEFAULT, it detects the desired format based on the file extension you give it.

The default behavior is to save the last ggplot object that you plotted to the graphic device, but you can pass it the name of any saved ggplot object. You can also of course change things like output dimensions and DPI, etc.
