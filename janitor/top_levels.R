top_levels Generate a frequency table of a factor grouped into top-n, bottom-n,
...
show_na should cases where the variable is NA be shown?
  Value
Returns a data.frame (actually a tbl_df) with the frequencies of the grouped, tabulated variable.
